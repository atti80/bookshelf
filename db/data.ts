...
When it comes right down to it, though, The Mighty Boosh did a far superior job of capturing the terror of the arctic. When Howard admonishes Vince that "The arctic is no respecter of fashion," I still get chills. The same cannot be said of my reaction to The Terror.`,
    ...
    publishedAt: new Date(),
    linkUrl:
      "https://www.amazon.com/gp/product/B000PAAH3A/ref=x_gr_bb_kindle?caller=Goodreads&tag=x_gr_bb_kindle-20",
  },
  {
    title: "The Nix",
    content: `I'm not a huge fan of long novels. This one, however, was without a doubt worth the time.
...
I cannot stress more how incredible this book is. It is just an all-around good time and a marvelous example of magical-realism used to its highest capacity. Despite it’s often dark and macabre nature, it is uplifting and laugh out loud funny. Plus, the ending is a kick to the head. I read much of this through the subways of Boston recently while on a much-needed and exceptional vacation, and, like Pilate and his crucified friend, the memory of both have become one. Bulgakov’s masterpiece has survived censorship and translation to make it to you, don’t pass it by!`,
    ...
    publishedAt: new Date(),
    linkUrl:
      "https://www.amazon.com/gp/product/B07NJB7PJN/ref=x_gr_bb_kindle?caller=Goodreads&tag=x_gr_bb_kindle-20",
  },
];
...
I’m going to have to add SGJ officially to my favourite list of horror writers. Obviously I recommend this one highly. But that recommendation comes with a warning for a gut-wrenching, painful, but necessary read for understanding the true weight of history.`,
  ...
  },
  {
    ...
    content: `The Cookbook Club by Beth Harbison is a women’s fiction title about three very different women who come together and find they do have things in common. The point of view in the story will of course change the during the course of the book.
...
I need more books like this in my life!!! If I could give it more stars than 5, I would.`,
  ...
  {
    title: "Lyneham",
    content: `Finding a planet habitable for humans doesn't seem all that difficult, given the abundance of things in the universe: there are solar systems everywhere, and the assumption that "life" develops in a similar way is a reasonable one, or at least that's what we believe in our limited perspective. Only the time to bridge the gap is the crucial point. That's what you think. At least I do. But is that really the case?

I've read two books by this author so far, and they left very different impressions on me: First, Athos 2643, a science fiction thriller from the perspective of an AI, which I found very unusual and difficult to read, but I really enjoyed it in its uniqueness!
And Core Shadow, a science thriller from 2014, perhaps more from the author's early days as a writer, as neither the characters nor the plot really convinced me.

That's precisely why I was curious to see how I would like his new book, because the blurb sounded extremely promising.

When I first read the prologue, I just thought: Wow! It really blew my mind because Nils Westerboer begins with a small experiment that many of you are surely familiar with, and then shifts to the recurring goal of many people to colonize another planet. The ideas behind this were so coherent and yet completely new to me that I had to let it sink in.

"If you're flying a hundred meters a second and your ship crashes into something, and you're not in your room, you become a painting on the wall."
Quote

The first chapter begins with the arrival on Perm. Henry is 12 when he, his father, and his two siblings want to find a new home on the moon in a distant solar system. Initially, there's not much discussion about why this new planet is supposed to be home—except that the habitability here isn't as high as expected, and above all, there are certain anomalies on the surface that pose a danger; and Henry's father is supposed to help research them.
Henry and the other children quickly learn to adapt to this life, even though they are acutely aware of how unreal it all seems to them.

When our eyes met, I realized that I should never be jealous of him and the light he carried within him. Envy would take me further away from it than I could ever imagine. The only way to receive some of Melcher's light was to love it.
Quote
...
And so what choice do we have? We turn to stories. These four are some of the best.`,
  ...
  },
  {
    ...
    content: `Blood Beneath the Snow was unfortunately a letdown for me. Sigh. I really loved the idea of a wintery tournament where siblings fight to death to win a crown. What I got instead was 200 pages of training sequences and a main character who constantly needed to remind everyone of how terrible but also how special she was at the same time. *Pulls hair out*
...
To me, this felt like a poor attempt at a mash up of many popular romantasies. If these tropes are your jam though, give it a try - hope that it works better for you. If you're looking for something well written, original and thoroughly entertaining - might give it a pass.`,
  ...
  },
  {
    ...
    content: `Oh how sweet was this book! (at least the second half)
