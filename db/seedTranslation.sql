...
VALUES
  ...
  ('password_reset', 'en', 'Your password has been reset. You will be redirected to the login page.'),
  ('password_reset', 'hu', 'A jelszavad be lett állítva. Most átirányítunk a bejelentkezési oldalra.'),
